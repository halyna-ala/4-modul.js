const orders = [
  ...
  const messages = [];
   for (let order = 0; order < Object.keys(orders).length; order += 1) {
     messages.push(composeMessage.call(orders[order], order))
    }
    ...
    // zadacza 8  // Пиши код ниже этой строки
    //   function composeMessage(position) {
...
//    composeMessage.call(`Готовим this.dish для this.email. Ваш заказ this.position-й в очереди.`)
//   }

//   // Пиши код ниже этой строки
//   function composeMessage(position) {
//   console.log(`Готовим ${this.dish} для ${this.email}. Ваш заказ ${position} в очереди.`);
//   }
...
//  Ваш заказ 1-й в очереди.', 'Готовим Pizza для artemis@coldmail.net. Ваш заказ
//   2-й в очереди.', 'Готовим Taco для jacob@mail.com. Ваш заказ 3-й в очереди.'].